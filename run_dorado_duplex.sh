...
porechop -i $out_dir/"$run"_duplex.fastq.gz -o $out_dir/"$run"_duplex.trimmed.fastq.gz --format fastq.gz --threads 20 &> $out_dir/"$run"_duplex.porechop.log
...
porechop -i $out_dir/"$run"_splitduplex.fastq.gz -o $out_dir/"$run"_splitduplex.trimmed.fastq.gz --format fastq.gz --threads 20 &> $out_dir/"$run"_splitduplex.porechop.log
echo END: `date`;
